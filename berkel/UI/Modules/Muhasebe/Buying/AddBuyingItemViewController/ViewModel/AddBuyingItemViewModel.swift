...
protocol IAddBuyingItemViewModel: AddBuyingItemDataSourceFactoryOutputDelegate {
    ...
    // Coordinator
    func presentAddSellerViewController(passData: AddSellerPassData)
}
...
internal extension AddBuyingItemViewModel {
    ...
    func presentAddSellerViewController(passData: AddSellerPassData) {
        self.coordinator.presentAddSellerViewController(passData: passData,
                                                        outputDelegate: self)
    }
...
extension AddBuyingItemViewModel {
    ...
    func updateTapped(uiModel: IAddBuyingItemTableViewCellUIModel) {
        self.presentAddSellerViewController(passData: AddSellerPassData(sellerInformation: uiModel))
    }
