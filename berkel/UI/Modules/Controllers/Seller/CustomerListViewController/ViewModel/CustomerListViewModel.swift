...
internal extension CustomerListViewModel {
    ...
    func presentNewCustomerViewController(passData: NewCustomerPassData) {
        self.coordinator.presentNewCustomerViewController(passData: passData,
                                                          outputDelegate: self)
    }
...
extension CustomerListViewModel {
    ...
    func updateTapped(uiModel: ICustomerListTableViewCellUIModel) {
        self.presentNewCustomerViewController(passData: NewCustomerPassData(customerInformation: uiModel))
    }
