...
protocol OrderTableViewCellOutputDelegate: AnyObject {
...
class OrderTableViewCell: BaseTableViewCell {
    ...
    weak var outputDelegate: OrderTableViewCellOutputDelegate? = nil
    ...
    func registerEvents(uiModel: IOrderTableViewCellUIModel) {
    ...
    func configureCellWith(uiModel: IOrderTableViewCellUIModel) {
        ...
        self.lblName.text = uiModel.jbCustomerName
